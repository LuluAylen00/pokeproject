...
export type Terrain = 'Eléctrico' | 'Grassy' | 'Psíquico' | 'Misty';
...
export type TypeName = 'Normal' | 'Lucha' | 'Volador' | 'Veneno' | 'Tierra' | 'Roca' | 'Bicho' | 'Fantasma' | 'Acero' | 'Fuego' | 'Agua' | 'Planta' | 'Eléctrico' | 'Psíquico' | 'Hielo' | 'Dragón' | 'Siniestro' | 'Hada' | '???';
